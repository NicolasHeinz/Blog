...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'/src/LoginBundle/Entity'), 1 => ($this->targetDirs[3].'/src/EntradaBundle/Entity')]);
$d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver([($this->targetDirs[3].'/vendor/friendsofsymfony/oauth-server-bundle/Resources/config/doctrine') => 'FOS\\OAuthServerBundle\\Entity']);
$d->setGlobalBasename('mapping');

$b->addDriver($c, 'LoginBundle\\Entity');
$b->addDriver($c, 'EntradaBundle\\Entity');
$b->addDriver($d, 'FOS\\OAuthServerBundle\\Entity');

$a->setEntityNamespaces(['LoginBundle' => 'LoginBundle\\Entity', 'EntradaBundle' => 'EntradaBundle\\Entity', 'FOSOAuthServerBundle' => 'FOS\\OAuthServerBundle\\Entity']);
