 ...
 */
class AuthCode extends \EntradaBundle\Entity\AuthCode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EntradaBundle\\Entity\\AuthCode' . "\0" . 'id', '' . "\0" . 'EntradaBundle\\Entity\\AuthCode' . "\0" . 'clientId', '' . "\0" . 'EntradaBundle\\Entity\\AuthCode' . "\0" . 'userId'];
        }
