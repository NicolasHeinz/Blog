 ...
 */
class RefreshToken extends \EntradaBundle\Entity\RefreshToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EntradaBundle\\Entity\\RefreshToken' . "\0" . 'id', '' . "\0" . 'EntradaBundle\\Entity\\RefreshToken' . "\0" . 'clientId', '' . "\0" . 'EntradaBundle\\Entity\\RefreshToken' . "\0" . 'userId', '' . "\0" . 'EntradaBundle\\Entity\\RefreshToken' . "\0" . 'token', '' . "\0" . 'EntradaBundle\\Entity\\RefreshToken' . "\0" . 'expiresAt', '' . "\0" . 'EntradaBundle\\Entity\\RefreshToken' . "\0" . 'scope'];
        }
