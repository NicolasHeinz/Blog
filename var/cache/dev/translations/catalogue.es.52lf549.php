...
$catalogue = new MessageCatalogue('es', array (
  ...
  'messages' => 
  array (
    'kiliktable.showing_entries' => '{0} no se encuentra nada guardado |{1} vista de 1 elemento filtrado |]1,Inf[ vista del elemento %firstRow% à %lastRow% de %filteredRows% elementos',
    'kiliktable.filtered_from' => '{1} filtrado desde %totalRows% elementos |]1,Inf[ filtrados desde %totalRows% elementos',
    'kiliktable.previous' => 'anterior',
    'kiliktable.next' => 'siguiente',
    'kiliktable.show' => 'mostrar',
    'kiliktable.rows_per_page' => 'elementos por página',
    'kiliktable.setup' => 'configuración',
    'kiliktable.mass_select' => 'seleccionar todo',
    'kiliktable.select' => 'seleccionar',
  ),
));
...
$catalogueEn = new MessageCatalogue('en', array (
  ...
  'messages' => 
  array (
    'kiliktable.showing_entries' => '{0} no matching records found | {1} showing 1 filtered entity |]1,Inf[ showing %firstRow% to %lastRow% of %filteredRows% entries',
    'kiliktable.filtered_from' => 'filtered from %totalRows% total entries',
    'kiliktable.previous' => 'previous',
    'kiliktable.next' => 'next',
    'kiliktable.show' => 'show',
    'kiliktable.rows_per_page' => 'rows per page',
    'kiliktable.setup' => 'setup',
    'kiliktable.mass_select' => 'select all',
    'kiliktable.select' => 'select',
  ),
));
