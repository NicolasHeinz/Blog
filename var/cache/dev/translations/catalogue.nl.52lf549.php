...
$catalogue = new MessageCatalogue('nl', array (
  ...
  'messages' => 
  array (
    'kiliktable.showing_entries' => '{0} geen records die overeenstemmen | {1} toont 1 gefilterde entiteit |]1,Inf[ laten zien %firstRow% tot %lastRow% van %filteredRows% inzendingen',
    'kiliktable.filtered_from' => 'gefilterd van %totalRows% in totaal inzendingen',
    'kiliktable.previous' => 'voorgaand',
    'kiliktable.next' => 'volgende',
    'kiliktable.show' => 'tonen',
    'kiliktable.rows_per_page' => 'rijen per pagina',
    'kiliktable.setup' => 'configureren',
    'kiliktable.mass_select' => 'selecteer alles',
    'kiliktable.select' => 'selecteer',
  ),
));
