...
namespace Proxies\__CG__\LoginBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \LoginBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LoginBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'LoginBundle\\Entity\\User' . "\0" . 'entradas', '' . "\0" . 'LoginBundle\\Entity\\User' . "\0" . 'name', '' . "\0" . 'LoginBundle\\Entity\\User' . "\0" . 'surname', '' . "\0" . 'LoginBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'LoginBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'LoginBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'LoginBundle\\Entity\\User' . "\0" . 'createdDate', '' . "\0" . 'LoginBundle\\Entity\\User' . "\0" . 'active', '' . "\0" . 'LoginBundle\\Entity\\User' . "\0" . 'rol'];
        }
    ...
    public function addEntrada(\EntradaBundle\Entity\Entrada $entrada)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addEntrada', [$entrada]);
    ...
    public function removeEntrada(\EntradaBundle\Entity\Entrada $entrada)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeEntrada', [$entrada]);

        return parent::removeEntrada($entrada);
    }
