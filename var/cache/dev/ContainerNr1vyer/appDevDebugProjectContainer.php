...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = [
            ...
            'loginbundle\\controller\\defaultcontroller' => 'LoginBundle\\Controller\\DefaultController',
        ...
        $this->fileMap = [
            ...
            'LoginBundle\\Controller\\DefaultController' => 'getDefaultController2Service.php',
            ...
            'app.generate_code' => 'getApp_GenerateCodeService.php',
            'app.transform_text' => 'getApp_TransformTextService.php',
            ...
            'fos_oauth_server.security.entry_point' => 'getFosOauthServer_Security_EntryPointService.php',
            ...
            'kilik_table' => 'getKilikTableService.php',
            'kilik_table_api' => 'getKilikTableApiService.php',
            ...
            'security.authentication.listener.anonymous.token' => 'getSecurity_Authentication_Listener_Anonymous_TokenService.php',
            'security.authentication.listener.form.main' => 'getSecurity_Authentication_Listener_Form_MainService.php',
            'security.authentication.listener.fos_oauth_server.api' => 'getSecurity_Authentication_Listener_FosOauthServer_ApiService.php',
            'security.authentication.listener.fos_oauth_server.token' => 'getSecurity_Authentication_Listener_FosOauthServer_TokenService.php',
            'security.authentication.provider.anonymous.main' => 'getSecurity_Authentication_Provider_Anonymous_MainService.php',
            'security.authentication.provider.anonymous.token' => 'getSecurity_Authentication_Provider_Anonymous_TokenService.php',
            'security.authentication.provider.dao.main' => 'getSecurity_Authentication_Provider_Dao_MainService.php',
            'security.authentication.provider.fos_oauth_server.api' => 'getSecurity_Authentication_Provider_FosOauthServer_ApiService.php',
            'security.authentication.provider.fos_oauth_server.token' => 'getSecurity_Authentication_Provider_FosOauthServer_TokenService.php',
            ...
            'security.firewall.map.context.token' => 'getSecurity_Firewall_Map_Context_TokenService.php',
            'security.http_utils' => 'getSecurity_HttpUtilsService.php',
            'security.password_encoder' => 'getSecurity_PasswordEncoderService.php',
            'security.request_matcher.kgqipw2' => 'getSecurity_RequestMatcher_Kgqipw2Service.php',
            ...
            'service_locator.drdp9yf' => 'getServiceLocator_Drdp9yfService.php',
        ...
        $this->privates = [
            ...
            'security.authentication.session_strategy.token' => true,
            ...
            'security.authentication.listener.anonymous.token' => true,
            'security.authentication.listener.form.main' => true,
            'security.authentication.listener.fos_oauth_server.api' => true,
            'security.authentication.listener.fos_oauth_server.token' => true,
            'security.authentication.manager' => true,
            'security.authentication.provider.anonymous.main' => true,
            'security.authentication.provider.anonymous.token' => true,
            'security.authentication.provider.dao.main' => true,
            'security.authentication.provider.fos_oauth_server.api' => true,
            'security.authentication.provider.fos_oauth_server.token' => true,
            ...
            'security.firewall.map.context.token' => true,
            'security.http_utils' => true,
            'security.logout_url_generator' => true,
            'security.rememberme.response_listener' => true,
            'security.request_matcher.kgqipw2' => true,
        ...
        $this->aliases = [
            ...
            'security.authentication.session_strategy.token' => 'security.authentication.session_strategy.api',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('zu2qX7LG85', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6mSiCtWwJ5', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wPMfJMCWg0', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wVqmRj20a2', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1lWzN+DTFq', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b80c4e95e2392fb2de1886b13544840e8950e9cd'))) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['security.authentication.provider.fos_oauth_server.api']) ? $this->services['security.authentication.provider.fos_oauth_server.api'] : $this->load('getSecurity_Authentication_Provider_FosOauthServer_ApiService.php')) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['security.authentication.provider.fos_oauth_server.token']) ? $this->services['security.authentication.provider.fos_oauth_server.token'] : $this->load('getSecurity_Authentication_Provider_FosOauthServer_TokenService.php')) && false ?: '_'};
            yield 2 => ${($_ = isset($this->services['security.authentication.provider.anonymous.token']) ? $this->services['security.authentication.provider.anonymous.token'] : ($this->services['security.authentication.provider.anonymous.token'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider($this->getParameter('container.build_hash')))) && false ?: '_'};
            yield 3 => ${($_ = isset($this->services['security.authentication.provider.dao.main']) ? $this->services['security.authentication.provider.dao.main'] : $this->load('getSecurity_Authentication_Provider_Dao_MainService.php')) && false ?: '_'};
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(['security.firewall.map.context.api' => function () {
        ...
        }, 'security.firewall.map.context.token' => function () {
            return ${($_ = isset($this->services['security.firewall.map.context.token']) ? $this->services['security.firewall.map.context.token'] : $this->load('getSecurity_Firewall_Map_Context_TokenService.php')) && false ?: '_'};
            ...
            yield 'security.firewall.map.context.token' => ${($_ = isset($this->services['security.request_matcher.kgqipw2']) ? $this->services['security.request_matcher.kgqipw2'] : ($this->services['security.request_matcher.kgqipw2'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/token'))) && false ?: '_'};
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/LoginBundle/Resources/views'), 'Login');
        $instance->addPath(($this->targetDirs[3].'/src/LoginBundle/Resources/views'), '!Login');
        $instance->addPath(($this->targetDirs[3].'/src/HomeBundle/Resources/views'), 'Home');
        $instance->addPath(($this->targetDirs[3].'/src/HomeBundle/Resources/views'), '!Home');
        $instance->addPath(($this->targetDirs[3].'/src/EntradaBundle/Resources/views'), 'Entrada');
        $instance->addPath(($this->targetDirs[3].'/src/EntradaBundle/Resources/views'), '!Entrada');
        $instance->addPath(($this->targetDirs[3].'/vendor/kilik/table/Resources/views'), 'KilikTable');
        $instance->addPath(($this->targetDirs[3].'/vendor/kilik/table/Resources/views'), '!KilikTable');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b80c4e95e2392fb2de1886b13544840e8950e9cd');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'LoginBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/LoginBundle'),
                ...
                'EntradaBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/EntradaBundle'),
                    'namespace' => 'EntradaBundle',
                ],
                'KilikTableBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/vendor/kilik/table'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'EntradaBundle' => 'EntradaBundle\\EntradaBundle',
            ...
            'secret' => 'b80c4e95e2392fb2de1886b13544840e8950e9cd',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'b80c4e95e2392fb2de1886b13544840e8950e9cd',
            ...
            'fos_oauth_server.model.client.class' => 'FOS\\OAuthServerBundle\\Entity\\Client',
            'fos_oauth_server.model.access_token.class' => 'FOS\\OAuthServerBundle\\Entity\\AccessToken',
            'fos_oauth_server.model.refresh_token.class' => 'FOS\\OAuthServerBundle\\Entity\\RefreshToken',
            'fos_oauth_server.model.auth_code.class' => 'FOS\\OAuthServerBundle\\Entity\\AuthCode',
