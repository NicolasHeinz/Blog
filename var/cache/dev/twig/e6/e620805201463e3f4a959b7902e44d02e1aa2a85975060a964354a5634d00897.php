...
/* HomeBundle:t:_formLeftNoTable.html.twig */
class __TwigTemplate_3bf1c76383a77739927e14c8f7954aa1c2ac2155748cd3f5613bd0c8cd4064f6 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "HomeBundle:t:_formLeftNoTable.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "HomeBundle:t:_formLeftNoTable.html.twig"));

        // line 3
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock(twig_get_attribute($this->env, $this->source, (isset($context["table"]) || array_key_exists("table", $context) ? $context["table"] : (function () { throw new RuntimeError('Variable "table" does not exist.', 3, $this->source); })()), "formView", [], "any", false, false, false, 3), 'form_start');
        echo "
";
        // line 4
    ...
    <div class=\"col-xs-12 col-sm-8\">
        ...
        <div id=\"";
        // line 20
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["table"]) || array_key_exists("table", $context) ? $context["table"] : (function () { throw new RuntimeError('Variable "table" does not exist.', 20, $this->source); })()), "bodyId", [], "any", false, false, false, 20), "html", null, true);
        echo "\">
            ";
        // line 21
...
";
        ...
        // line 59
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock(twig_get_attribute($this->env, $this->source, (isset($context["table"]) || array_key_exists("table", $context) ? $context["table"] : (function () { throw new RuntimeError('Variable "table" does not exist.', 59, $this->source); })()), "formView", [], "any", false, false, false, 59), 'form_end');
        echo "
";
    ...
    public function block_tableHead($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["table"]) || array_key_exists("table", $context) ? $context["table"] : (function () { throw new RuntimeError('Variable "table" does not exist.', 9, $this->source); })()), "columns", [], "any", false, false, false, 9));
        $context['loop'] = [
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
            // line 10
            echo "                ";
            $this->loadTemplate("@KilikTable/_columnNameNoTable.html.twig", "HomeBundle:t:_formLeftNoTable.html.twig", 10)->display($context);
            // line 11
            echo "                ";
            $this->loadTemplate("@KilikTable/_columnFilterNoTable.html.twig", "HomeBundle:t:_formLeftNoTable.html.twig", 11)->display($context);
            // line 12
            echo "            ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
    ...
    public function block_tableBody($context, array $blocks = [])
    {
        ...
        if ((isset($context["tableRenderBody"]) || array_key_exists("tableRenderBody", $context))) {
            ...
            echo "                    ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["rows"]) || array_key_exists("rows", $context) ? $context["rows"] : (function () { throw new RuntimeError('Variable "rows" does not exist.', 24, $this->source); })()));
            $context['loop'] = [
              'parent' => $context['_parent'],
              'index0' => 0,
              'index'  => 1,
    ...
    public function block_tableBodyStdColumns($context, array $blocks = [])
    {
        ...
        echo "                                ";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["table"]) || array_key_exists("table", $context) ? $context["table"] : (function () { throw new RuntimeError('Variable "table" does not exist.', 27, $this->source); })()), "columns", [], "any", false, false, false, 27));
        $context['loop'] = [
          'parent' => $context['_parent'],
          'index0' => 0,
          'index'  => 1,
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
            ...
            echo "                                    <div class=\"col-xs-6 col-sm-3\">
                                        ";
            // line 29
            $this->loadTemplate("@KilikTable/_columnCellNoTable.html.twig", "HomeBundle:t:_formLeftNoTable.html.twig", 29)->display($context);
            // line 30
            echo "                                    </div>
                                ";
            ++$context['loop']['index0'];
    ...
    public function block_tableStats($context, array $blocks = [])
    {
        ...
        // line 40
        echo "            <div id=\"";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["table"]) || array_key_exists("table", $context) ? $context["table"] : (function () { throw new RuntimeError('Variable "table" does not exist.', 40, $this->source); })()), "id", [], "any", false, false, false, 40), "html", null, true);
        echo "_stats\">
                ";
        // line 41
    ...
    public function block_tableStatsAjax($context, array $blocks = [])
    {
        ...
        // line 42
        echo "                    ";
        $this->loadTemplate("@KilikTable/_stats.html.twig", "HomeBundle:t:_formLeftNoTable.html.twig", 42)->display($context);
        // line 43
        echo "                ";
    ...
    public function block_tablePagination($context, array $blocks = [])
    {
        ...
        // line 48
        echo "            <div id=\"";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["table"]) || array_key_exists("table", $context) ? $context["table"] : (function () { throw new RuntimeError('Variable "table" does not exist.', 48, $this->source); })()), "id", [], "any", false, false, false, 48), "html", null, true);
    ...
    public function block_tablePaginationAjax($context, array $blocks = [])
    {
        ...
        // line 50
        echo "                    ";
        $this->loadTemplate("@KilikTable/_paginationNumbersIcons.html.twig", "HomeBundle:t:_formLeftNoTable.html.twig", 50)->display($context);
        // line 51
        echo "                ";
    ...
    {
        return "HomeBundle:t:_formLeftNoTable.html.twig";
    }
    ...
    {
        return array (  436 => 57,  426 => 51,  423 => 50,  413 => 49,  402 => 52,  400 => 49,  395 => 48,  385 => 47,  375 => 43,  372 => 42,  362 => 41,  351 => 44,  349 => 41,  344 => 40,  334 => 39,  324 => 32,  309 => 30,  307 => 29,  304 => 28,  286 => 27,  276 => 26,  266 => 36,  263 => 35,  248 => 33,  246 => 26,  243 => 25,  225 => 24,  222 => 23,  220 => 22,  210 => 21,  199 => 17,  189 => 16,  179 => 13,  165 => 12,  162 => 11,  159 => 10,  141 => 9,  131 => 8,  113 => 4,  101 => 59,  99 => 57,  94 => 54,  92 => 47,  89 => 46,  87 => 39,  83 => 37,  81 => 21,  77 => 20,  74 => 19,  72 => 16,  68 => 14,  66 => 8,  62 => 7,  59 => 6,  57 => 4,  53 => 3,);
    }

    public function getSourceContext()
    {
        return new Source("{# Alternative display (without table) #}
    ...
    <div class=\"col-xs-12 col-sm-4\" id=\"{{ table.id }}\">
        {% block tableHead %}
            {% for column in table.columns %}
                {% include \"@KilikTable/_columnNameNoTable.html.twig\" %}
                {% include \"@KilikTable/_columnFilterNoTable.html.twig\" %}
            {% endfor %}
        {% endblock tableHead %}
    </div>
    <div class=\"col-xs-12 col-sm-8\">
                            ...
                            {% block tableBodyStdColumns %}
                                {% for column in table.columns %}
                                    <div class=\"col-xs-6 col-sm-3\">
                                        {% include \"@KilikTable/_columnCellNoTable.html.twig\" %}
                                    </div>
                                {% endfor %}
...
", "HomeBundle:t:_formLeftNoTable.html.twig", "/home/nicolas/Documentos/Blog/src/HomeBundle/Resources/views/t/_formLeftNoTable.html.twig");
    }
}
